...
import petcare.config.auth.PrincipalMember;
...
public class BoardController {
	...
	public String bcinsert(BoardCounsel board, HttpSession session,@AuthenticationPrincipal PrincipalMember principal) {
	...
	//자유게시판 상세보기
		...
		public String bqinsert(BoardQuestion board, HttpSession session,@AuthenticationPrincipal PrincipalMember principal) {
			String uploadFolder=session.getServletContext().getRealPath("/")+"\\resources\\img";
