...
<table class="table">
    ...
    <table class="table">
					...
					<div>
						...
						<div class="writer ub-writer" data-nick="작성자" data-uid="" data-loc="view">
							<div class="fl">
								<span class='nickname' title='작성자'>작성자:<em>${board.username } | </em></span></span>		
  ...
  <hr>
  <br>	<p align="right">
<c:if test="${principal.mb.username==board.member.username }">
	...
	var init=function(){
		...
		.done(function(resp){
			...
			$.each(resp,function(key,val){
				...
				//if("${principal.mb.memberID}"==val.username){
