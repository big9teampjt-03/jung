...
<div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="username" placeholder="Enter writer" name="username"  value="<sec:authentication property="Principal.username"/>"  readonly="readonly">
    </div>
    <div class="form-group">
